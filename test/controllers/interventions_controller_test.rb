...
class InterventionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create intervention" do
    assert_difference('Intervention.count') do
      post interventions_url, params: { intervention: { author: @intervention.author, batteryID: @intervention.batteryID, buildingID: @intervention.buildingID, columnID: @intervention.columnID, customerID: @intervention.customerID, elevatorID: @intervention.elevatorID, employeeID: @intervention.employeeID, endDateAndTimeOfIntervention: @intervention.endDateAndTimeOfIntervention, report: @intervention.report, result: @intervention.result, startDateAndTimeOfIntervention: @intervention.startDateAndTimeOfIntervention, status: @intervention.status } }
    end
